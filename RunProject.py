...
params.dim_window = 96  # exemplele pozitive (fete de oameni cropate) au 36x36 pixeli
params.dim_hog_cell = 12  # dimensiunea celulei
params.dim_descriptor_cell = 144  # dimensiunea descriptorului unei celule
params.overlap = 0.3
...
# print(positive_features.shape[1])
# print(negative_features.shape[1])
...
np.save(os.path.join('fisiere_solutie/311_Talpiga_Andrei_Vlad/task1', 'detections_all_faces.npy'), detections)
np.save(os.path.join('fisiere_solutie/311_Talpiga_Andrei_Vlad/task1', 'scores_all_faces.npy'), scores)
np.save(os.path.join('fisiere_solutie/311_Talpiga_Andrei_Vlad/task1', 'file_names_all_faces.npy'), file_names)
